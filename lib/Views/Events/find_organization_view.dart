...
class FindOrganizationView extends StatefulWidget {
  ...
  @override
  _FindOrganizationViewState createState() => _FindOrganizationViewState();
}

class _FindOrganizationViewState extends State<FindOrganizationView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Find Organization'),
